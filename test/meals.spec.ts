...
describe('Meals routes', () => {
  ...
  it('should be able to list all meals from a user', async () => {
    ...
    const mealsResponse = await request(app.server).get('/meals').set('Cookie', cookie).expect(200)
  ...
  it('should be able to show a single meal', async () => {
    ...
    const mealResponse = await request(app.server).get(`/meals/${mealId}`).set('Cookie', cookie).expect(200)
  ...
  it('should be able to delete a meal from a user', async () => {
    ...
    await request(app.server).delete(`/meals/${mealId}`).set('Cookie', cookie).expect(204)
  })
  ...
  it('should be able to get metrics from a user', async () => {
    ...
    const metricsResponse = await request(app.server).get('/meals/metrics').set('Cookie', cookie).expect(200)
